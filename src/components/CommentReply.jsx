      ...
      >
        ...
        <img
          ...
          onError={(e) => {
            ...
            e.target.src = `https://ui-avatars.com/api/?name=${encodeURIComponent(comment.user_name)}&background=${isCurrentUser ? "000" : "666"}&color=fff`;
          }}
        />
            ...
            return (
              ...
              >
                ...
                <img
                  ...
                  onError={(e) => {
                    e.target.onerror = null;
                    e.target.src = `https://ui-avatars.com/api/?name=${encodeURIComponent(reply.user_name)}&background=${isReplyByCurrentUser ? "000" : "666"}&color=fff`;
                  }}
                />
